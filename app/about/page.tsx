export default function AboutPage() {
  return (
    <main className="mx-auto max-w-4xl px-6 py-16 bg-[#FAF7F3] text-[#2A2A2A]">
      {/* Founder Section */}
      <section className="flex flex-col md:flex-row md:items-start md:justify-between gap-8">
        ...
        <div className="flex-1 space-y-6">
          ...
          <p className="text-lg leading-relaxed">
            ...
            design, and SEO. I created Ottawa‑Menus to give local restaurants a
            modern, inclusive way to share their menus online — one that
      ...
      <section className="space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>SEO‑friendly</strong> — Search engines can index menu items
